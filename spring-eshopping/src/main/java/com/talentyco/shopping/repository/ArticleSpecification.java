...
import com.talentyco.shopping.domain.Brand;
import com.talentyco.shopping.domain.Category;
import com.talentyco.shopping.domain.Size;
...
public class ArticleSpecification {
    ...
    public static Specification<Article> filterBy(Integer priceLow, Integer priceHogh, List<String> sizes,
        ...
        return new Specification<Article>() {
            ...
            if (priceHogh != null && priceHogh >= 0) {
                predicates.add(criteriaBuilder.and(criteriaBuilder.lessThanOrEqualTo(root.get("price"), priceHogh)));
            }
